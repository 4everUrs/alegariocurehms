...
CREATE TABLE IF NOT EXISTS `disburse_requests` (
  ...
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `approve_amount` bigint DEFAULT NULL,
...
-- Dumping structure for table alergiocurehms.journal_entries
CREATE TABLE IF NOT EXISTS `journal_entries` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `encoder` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dumping structure for table alergiocurehms.payables
